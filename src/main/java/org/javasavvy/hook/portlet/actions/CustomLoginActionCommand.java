...
public class CustomLoginActionCommand implements LifecycleAction {
	...
	public void processLifecycleEvent(LifecycleEvent lifecycleEvent)
    	...
    	try {
			LoginUtil.getAuthenticatedUserId(request, request.getParameter("login"), request.getParameter("password"), authType);
